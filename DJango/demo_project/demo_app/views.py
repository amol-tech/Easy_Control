...
from demo_app.models import Department,Employee,School,Student
from . import forms
...
class CBView(TemplateView):
    template_name = 'demo_app/index_cbv.html'

    def get_context_data(self,**kwargs):
        context = super().get_context_data(**kwargs)
        context['user_contents'] = 'Here its detailed user information'
        return context

class SchoolIndexView(TemplateView):
    template_name = 'demo_app/school_welcome.html'

class SchoolListView(ListView):
    model = School
    # school_list is the variable generated by ListVIew model
...
class SchoolDeleteView(DeleteView):
    print('****** Reached Here')
    model = School
    success_url = reverse_lazy('demo_app:list_school')
...
def index_cbv(request):
    return render(request,'demo_app/index_cbv.html')